          ...
          {(() => {
            ...
            const renderers = {
              ...
              products: () => profile?.show_products && profile?.products?.length > 0 && (
                <div key="products" style={{ background: cardBg, borderRadius: 24, padding: 20, boxShadow: isDark ? '0 10px 30px rgba(0,0,0,0.2)' : '0 4px 20px rgba(0,0,0,0.03)', border: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.05)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.products || 'Boutique'}</h3>
                    </div>
                    ...
                    {profile.show_location && profile.location_address && (
                        <div style={{ marginBottom: profile.show_hours ? 20 : 0 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                                ...
                                <h3 style={{ fontSize: 15, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.business_info_find || 'Nous trouver'}</h3>
                            </div>
                        ...
                        <div>
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                    ...
                                    <h3 style={{ fontSize: 15, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.business_info_hours || 'Horaires'}</h3>
                                </div>
              ...
              gallery: () => {
                ...
                if (!profile?.show_gallery || items.length === 0) return null;
                return (
              ...
              skills: () => profile?.show_skills && profile?.skills?.length > 0 && (
                <div key="skills" style={{ background: cardBg, borderRadius: 24, padding: 20, boxShadow: isDark ? '0 10px 30px rgba(0,0,0,0.2)' : '0 4px 20px rgba(0,0,0,0.03)', border: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.05)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.skills || 'Compétences'}</h3>
                    </div>
              ...
              testimonials: () => profile?.show_testimonials && (
                <div key="testimonials" style={{ background: cardBg, borderRadius: 24, padding: 20, boxShadow: isDark ? '0 10px 30px rgba(0,0,0,0.2)' : '0 4px 20px rgba(0,0,0,0.03)', border: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.05)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.testimonials || profile.feedback_title || 'Faites-nous un retour'}</h3>
                    </div>
                    {testimonialSuccess ? (
              ...
              faq: () => profile?.show_faq && profile?.faq?.length > 0 && (
                <div key="faq" style={{ background: cardBg, borderRadius: 24, padding: 20, boxShadow: isDark ? '0 10px 30px rgba(0,0,0,0.2)' : '0 4px 20px rgba(0,0,0,0.03)', border: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.05)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.faq || 'FAQ'}</h3>
                    </div>
              ...
              events: () => profile?.show_events && profile?.events?.length > 0 && (
                <div key="events" style={{ background: cardBg, borderRadius: 24, padding: 20, boxShadow: isDark ? '0 10px 30px rgba(0,0,0,0.2)' : '0 4px 20px rgba(0,0,0,0.03)', border: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.05)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.events || 'Événements'}</h3>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              portfolio: () => profile?.show_portfolio && profile?.portfolio?.length > 0 && (
                <div key="portfolio" style={{ background: cardBg, borderRadius: 24, padding: 20, boxShadow: isDark ? '0 10px 30px rgba(0,0,0,0.2)' : '0 4px 20px rgba(0,0,0,0.03)', border: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.05)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.portfolio || 'Portfolio'}</h3>
                    </div>
              ...
              certifications: () => profile?.show_certifications && profile?.certifications?.length > 0 && (
                <div key="certifications" style={{ background: cardBg, borderRadius: 24, padding: 20, boxShadow: isDark ? '0 10px 30px rgba(0,0,0,0.2)' : '0 4px 20px rgba(0,0,0,0.03)', border: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.05)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                        ...
                        <h3 style={{ fontSize: 16, fontWeight: 800, color: textColor, margin: 0 }}>{profile.section_titles?.certifications || 'Certifications'}</h3>
                    </div>
